...
const MediumIcon = props => (
  <svg width="15px" height="15px" viewBox="0 0 1024 866" style={iconStyles}>
      ...
      <Row>
        {noSocial ? null : (
          <SocialList>
            ...
            <SocialItem>
              <a
                id="gtm-twitter-footer"
                aria-label="Twitter"
                href="https://twitter.com/bitgenics"
                target="_self"
              >
                <TwitterIcon />
              </a>
            ...
            <SocialItem>
              <a
                id="gtm-github-footer"
                aria-label="Github"
                href="https://github.com/bitgenics/"
                target="_self"
              >
                <GithubIcon />
              </a>
